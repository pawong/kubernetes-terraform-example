...
```bash
% docker build -t library/express-example-image:latest --platform linux/amd64,linux/arm64 --build-arg GIT_HASH=$(git rev-parse --short HEAD) . # check your deployment platform
